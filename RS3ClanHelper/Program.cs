...
var services = new ServiceCollection()
    ...
    .AddSingleton<IHiscoreClient, HiscoreClient>()
    .AddSingleton<IActivityStore, FileActivityStore>()
    .AddSingleton<IActivityTrackerService, ActivityTrackerService>()
...
var inactive = services.GetRequiredService<IInactiveSummaryService>();
